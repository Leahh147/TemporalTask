...
using System.Linq;
using System;
using TemporalTask.Audio.Util;

namespace TemporalTask.Audio
{
    /// <summary>
    ...
    public class AudioSensorComponent : SensorComponent, IAudioSampler, IDisposable
    {
        ...
        private void Awake()
        {
            // if (simulatedUser.audioModeOn){ // needs adjustment because there might not be a simulated user
            //     UpdateSettings();
            // }
            Debug.Log("Awake"); // the settings will be manually updated in the RLenv.
        }
